...
const BOLT_BIN: &str = "/home/aknen/Documents/coding-projects/llm-pgo/bolt-build/bin/";

pub fn compile_bolt(target: &str, output: &str) -> Result<()> {
...
fn build_instrumented(target: &str) -> Result<String> {
    ...
    let bolt = format!("{}/llvm-bolt", BOLT_BIN);
